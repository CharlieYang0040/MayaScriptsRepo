...
def main():
    ...
    shelfButton
        ...
        -visible 1
        -preventOverride 0
        -annotation "find Texture File Name and Replace with Project Path" 
        -enableBackground 0
        ...
        -marginWidth 0
        -marginHeight 1
        -command "python(\\"import texturePathReplacer; texturePathReplacer.create_ui()\\")" 
        -sourceType "mel" 
        -commandRepeatable 1
        -flat 1
    ;'''
    ...
    for version in maya_versions:
        ...
        src_script_path = Path(sys._MEIPASS) / 'texturePathReplacer.py'
